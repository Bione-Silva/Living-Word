      ...
      <div style={{ maxWidth:600, margin:'0 auto', width:'100%', padding:24 }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <button onClick={() => {stopTimer(); setView('hub');}} style={{ background:'var(--cea-card-bg)', border:'1px solid var(--cea-border)', color:'var(--cea-text-1)', width:36, height:36, borderRadius:'50%', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center' }}>✕</button>
