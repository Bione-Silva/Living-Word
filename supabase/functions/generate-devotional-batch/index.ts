...
import { IMAGE_STYLES, pickStyle, isArtisticStyle, REALISTIC_ENFORCEMENT } from '../_shared/image-styles.ts'
...
// Estilos importados de _shared/image-styles.ts (fonte única de verdade)
// ============================================================================
