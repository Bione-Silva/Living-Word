      ...
      <div className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-8 lg:grid-cols-4 xl:grid-cols-8 gap-2 sm:gap-2.5">
        {actions.map((a) => {
          ...
          return (
            ...
            >
              <div className="w-full aspect-square max-h-14 rounded-xl bg-violet-50/80 border border-zinc-200 dark:bg-zinc-800/80 dark:border-zinc-700/50 flex items-center justify-center transition-all group-hover:bg-violet-100/80 group-hover:border-zinc-300 dark:group-hover:bg-zinc-700 group-active:scale-95">
