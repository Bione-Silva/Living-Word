export type CanvasTemplate = 'editorial' | 'swiss' | 'cinematic';
        ...
        {templates.map((t) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 px-3 py-3 rounded-xl text-center transition-all duration-200 border-2 ${
                active
            ...
            >
              ...
              <span className="text-[11px] font-bold leading-tight">{t.label[lang]}</span>
