...
import { buildSystemPrompt, PROMPTS_PESQUISA, PROMPTS_CRIACAO } from '@/lib/prompts';
...
const toolConfigs: Record<string, {
  ...
  'topic-explorer': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.topicExplorer, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'verse-finder': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.verseFinder, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'historical-context': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.historicalContext, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'quote-finder': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.quoteFinder, { includeRag: true }),
  },
  'movie-scenes': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.movieScenes, {}),
  },
  'original-text': {
    inputLabel: { PT: 'Passagem bíblica', EN: 'Bible passage', ES: 'Pasaje bíblico' },
    placeholder: { PT: 'Ex: João 3:16', EN: 'E.g.: John 3:16', ES: 'Ej: Juan 3:16' },
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.originalText, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'lexical': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_PESQUISA.lexical, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'title-gen': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.titleGen, {}),
  },
  'metaphor-creator': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.metaphorCreator, {}),
  },
  'bible-modernizer': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.bibleModernizer, { includeRag: true }),
  },
  'illustrations': {
    inputLabel: { PT: 'Tema do sermão', EN: 'Sermon topic', ES: 'Tema del sermón' },
    placeholder: { PT: 'Ex: perdão, graça, transformação', EN: 'E.g.: forgiveness, grace, transformation', ES: 'Ej: perdón, gracia, transformación' },
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.illustrations, {}),
  },
  'free-article': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.freeArticle, { includeRag: true }),
    useTextarea: true,
  },
  'youtube-blog': {
  ...
  'reels-script': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.reelsScript, {}),
  },
  'cell-group': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.cellGroup, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'social-caption': {
    inputLabel: { PT: 'Tema ou versículo', EN: 'Topic or verse', ES: 'Tema o versículo' },
    placeholder: { PT: 'Ex: Esperança em meio à dor', EN: 'E.g.: Hope amid pain', ES: 'Ej: Esperanza en medio del dolor' },
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.socialCaption, {}),
  },
  'newsletter': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.newsletter, {}),
  },
  'announcements': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.announcements, {}),
  },
  'trivia': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.trivia, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'poetry': {
    inputLabel: { PT: 'Tema ou passagem', EN: 'Topic or passage', ES: 'Tema o pasaje' },
    placeholder: { PT: 'Ex: Salmo 23, amor de Deus', EN: 'E.g.: Psalm 23, God\'s love', ES: 'Ej: Salmo 23, amor de Dios' },
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.poetry, {}),
  },
  'kids-story': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.kidsStory, { includeRag: true, includeAntiAlucinacao: true }),
  },
  'deep-translation': {
    ...
    systemPrompt: () => buildSystemPrompt(PROMPTS_CRIACAO.deepTranslation, {}),
    useTextarea: true,
  },
};
...
export function ToolSheet({ open, onOpenChange, toolId, toolTitle }: ToolSheetProps) {
  ...
  const config = toolConfigs[toolId] || {
    ...
    systemPrompt: () => buildSystemPrompt('Você é um assistente pastoral útil. Dado o input do usuário, gere conteúdo útil, bem estruturado, para líderes cristãos. Seja criativo, teologicamente sólido e prático. Formate com Markdown.', {}),
  };
