...
export default function BlogArticle() {
  ...
  // Build the canonical public URL (never share a preview/localhost URL)
  const articleUrl = useMemo(() => {
    if (typeof window === 'undefined') return '';
    const { origin, pathname } = window.location;
    // If we're on a preview/localhost, use the published domain instead
            ...
            <div className="relative" ref={shareRef}>
              ...
              {shareOpen && (
                <div className="absolute right-0 top-full mt-2 bg-white rounded-xl shadow-xl border border-[#3c2f21]/10 py-2 min-w-[180px] z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <button onClick={handleShareX} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#3c2f21] hover:bg-[#3c2f21]/5 transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    X (Twitter)
                  </button>
                  <button onClick={handleShareWhatsApp} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#3c2f21] hover:bg-[#3c2f21]/5 transition-colors">
                    <MessageCircle className="w-4 h-4" />
                    WhatsApp
                  </button>
                  <button onClick={handleShareTelegram} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#3c2f21] hover:bg-[#3c2f21]/5 transition-colors">
                  ...
                  <button onClick={handleShareLinkedIn} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#3c2f21] hover:bg-[#3c2f21]/5 transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                    LinkedIn
                  </button>
                  <button onClick={handleShareFacebook} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#3c2f21] hover:bg-[#3c2f21]/5 transition-colors">
      ...
      <article className="max-w-3xl mx-auto px-4 py-10 md:py-14">
        ...
        <div className="mt-14 pt-6 border-t border-[#3c2f21]/10 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <Button variant="outline" size="sm" onClick={handleCopyLink} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
              <Copy className="w-4 h-4 mr-2" /> Copiar Link
            </Button>
            <Button variant="outline" size="sm" onClick={handleShareWhatsApp} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
              <MessageCircle className="w-4 h-4 mr-2" /> WhatsApp
            </Button>
            <Button variant="outline" size="sm" onClick={handleShareX} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
            ...
            <Button variant="outline" size="sm" onClick={handleShareTelegram} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
            ...
            <Button variant="outline" size="sm" onClick={handleShareLinkedIn} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
              <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              LinkedIn
            </Button>
            <Button variant="outline" size="sm" onClick={handleShareFacebook} className="border-[#3c2f21]/15 text-[#6B4F3A] hover:bg-[#3c2f21]/5">
