...
import {
  ...
  Shield, ChevronRight, Database, Cpu, BookMarked, Wifi
} from 'lucide-react';
...
export default function MindProfile() {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-16">
      {/* Back */}
      <Button variant="ghost" size="sm" onClick={() => navigate('/dashboard/mentes')} className="mb-6 text-white/50 hover:text-white/80 gap-2 -ml-2">
        <ArrowLeft className="h-4 w-4" />
        {sectionLabels.backLabel[lang]}
      </Button>

      {/* ═══════════════════════════════════════════════════════════
          A. HERO — Cinematic header with photo, name, badges
          ═══════════════════════════════════════════════════════════ */}
      <section className="relative rounded-3xl border border-[hsl(43,30%,40%)]/15 bg-gradient-to-b from-[hsl(220,20%,10%)] via-[hsl(220,18%,8%)] to-[hsl(220,20%,6%)] p-8 sm:p-14 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          {/* Photo */}
          <div className="mx-auto w-36 h-36 sm:w-44 sm:h-44 rounded-full border-[3px] border-[hsl(43,55%,58%)]/30 overflow-hidden shadow-[0_0_60px_hsl(43,55%,58%,0.1)] mb-6 ring-4 ring-[hsl(43,55%,58%)]/[0.08] ring-offset-4 ring-offset-[hsl(220,20%,8%)]">
            <img src={mind.image} alt={mind.name} className="w-full h-full object-cover" width={176} height={176} />
          </div>

          {/* Name */}
          <h1 className="font-display text-4xl sm:text-5xl font-bold text-white/95 tracking-tight">{mind.name}</h1>
          <p className="text-lg sm:text-xl italic text-[hsl(43,55%,58%)]/70 mt-2 font-display">{mind.subtitle[lang]}</p>
          ...
          <div className="flex flex-wrap justify-center gap-2.5 mt-7">
            {mind.badges.map((badge, i) => (
              <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-full border border-[hsl(43,55%,58%)]/15 bg-[hsl(43,55%,58%)]/[0.06]">
                <Database className="h-3.5 w-3.5 text-[hsl(43,55%,58%)]/60" />
                <span className="text-xs font-medium text-white/60 font-mono">{badge[lang]}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          B. BIOGRAPHY — Long-form AI personality
          ═══════════════════════════════════════════════════════════ */}
      <section className="mt-5 rounded-2xl border border-[hsl(43,30%,40%)]/10 bg-[hsl(220,18%,9%)] p-7 sm:p-10">
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl bg-[hsl(43,55%,58%)]/10 flex items-center justify-center border border-[hsl(43,55%,58%)]/10">
            <Fingerprint className="h-5 w-5 text-[hsl(43,55%,58%)]" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-white/90">{sectionLabels.bio[lang]}</h2>
        ...
        <div className="pl-0 sm:pl-[52px]">
          <p className="text-[15px] sm:text-base leading-[1.9] text-white/55">
            {mind.bio[lang]}
          </p>
        </div>
      </section>
      ...
      {/* ═══════════════════════════════════════════════════════════
          C. SPECIALTIES & SIGNATURES — Two columns
          ═══════════════════════════════════════════════════════════ */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5">
        {/* Specialties */}
        <section className="rounded-2xl border border-[hsl(43,30%,40%)]/10 bg-[hsl(220,18%,9%)] p-7">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl bg-[hsl(43,55%,58%)]/10 flex items-center justify-center border border-[hsl(43,55%,58%)]/10">
              <Cpu className="h-5 w-5 text-[hsl(43,55%,58%)]" />
            </div>
            <h2 className="text-lg font-bold text-white/90">{sectionLabels.specialties[lang]}</h2>
          </div>
          <div className="space-y-2.5">
            {mind.specialties.map((s, i) => (
              <div key={i} className="flex items-start gap-3.5 px-4 py-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] transition-colors">
                ...
                <span className="text-sm text-white/70 font-medium">{s[lang]}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-[hsl(43,30%,40%)]/10 bg-[hsl(220,18%,9%)] p-7">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-bold text-white/90">{sectionLabels.signatures[lang]}</h2>
          </div>
          <div className="space-y-2.5">
            {mind.signatures.map((s, i) => (
              <div key={i} className="flex items-start gap-3.5 px-4 py-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] transition-colors">
                ...
                <span className="text-sm text-white/60 italic">{s[lang]}</span>
              </div>
            ))}
          </div>
        </section>
      ...
      {/* ═══════════════════════════════════════════════════════════
          THEOLOGICAL MATRIX — Deep cinematic section
          ═══════════════════════════════════════════════════════════ */}
      <section className="mt-5 rounded-2xl border border-[hsl(43,30%,40%)]/15 bg-gradient-to-br from-[hsl(220,20%,10%)] to-[hsl(220,18%,7%)] p-7 sm:p-10 overflow-hidden relative">
        <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[hsl(43,55%,58%)]/[0.04] rounded-full blur-[80px] pointer-events-none" />
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl bg-[hsl(43,55%,58%)]/10 flex items-center justify-center border border-[hsl(43,55%,58%)]/10">
            ...
            <div>
              <h2 className="text-lg font-bold text-white/90">{sectionLabels.theology[lang]}</h2>
              <p className="text-xs text-white/40 mt-0.5">
      ...
      {/* ═══════════════════════════════════════════════════════════
          D. REFERENCE WORKS — Books loaded into AI
          ═══════════════════════════════════════════════════════════ */}
      <section className="mt-5 rounded-2xl border border-[hsl(43,30%,40%)]/10 bg-[hsl(220,18%,9%)] p-7 sm:p-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-white/90">{sectionLabels.works[lang]}</h2>
            <p className="text-xs text-white/40 mt-0.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {mind.works.map((work, i) => (
            <div key={i} className="group flex items-center gap-4 px-5 py-4 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] hover:border-[hsl(43,55%,58%)]/15 transition-all">
              <div className="w-10 h-10 rounded-lg bg-[hsl(43,55%,58%)]/10 flex items-center justify-center shrink-0 group-hover:bg-[hsl(43,55%,58%)]/15 transition-colors">
                <BookOpen className="h-4 w-4 text-[hsl(43,55%,58%)]" />
              </div>
              <div className="min-w-0">
                <p className="text-sm font-semibold text-white/75 truncate">{work.title[lang]}</p>
                {work.year && <p className="text-[11px] text-white/35 mt-0.5 font-mono">{work.year}</p>}
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          E. ENGAGEMENT MODULE — Choose modality
          ═══════════════════════════════════════════════════════════ */}
      <section className="mt-5 rounded-3xl border border-[hsl(43,30%,40%)]/15 bg-gradient-to-b from-[hsl(220,20%,10%)] via-[hsl(220,18%,8%)] to-[hsl(220,20%,6%)] p-8 sm:p-10 overflow-hidden relative">
        ...
        {isLocked ? (
          <div className="relative z-10 text-center space-y-5 py-8">
            <div className="mx-auto w-16 h-16 rounded-2xl bg-[hsl(43,55%,58%)]/10 flex items-center justify-center border border-[hsl(43,55%,58%)]/15">
            ...
            <p className="text-sm text-white/40 max-w-md mx-auto">{sectionLabels.upgradePrice[lang]}</p>
            <Button
              onClick={() => navigate('/upgrade')}
              className="px-10 py-6 text-base font-bold bg-gradient-to-r from-[hsl(43,55%,48%)] to-[hsl(35,45%,38%)] hover:from-[hsl(43,55%,55%)] hover:to-[hsl(35,45%,45%)] text-white gap-2 rounded-xl shadow-lg"
            >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-xl font-bold text-white/90">{sectionLabels.engage[lang]}</h2>
            </div>
            <p className="text-sm text-white/40 mb-6 pl-[52px]">{sectionLabels.chooseMode[lang]}</p>
              ...
              {modalities.map((mod) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative text-left p-5 rounded-2xl bg-gradient-to-br ${mod.color} border ${mod.border} transition-all duration-300 hover:shadow-lg`}
                  >
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-xl bg-white/[0.06] flex items-center justify-center shrink-0 text-2xl border border-white/[0.06]">
                        {mod.emoji}
                      </div>
                      <div className="min-w-0 flex-1">
                        <h3 className="text-base font-bold text-white/90 mb-1">{mod.label[lang]}</h3>
                        <p className="text-xs text-white/45 leading-relaxed">{mod.description[lang]}</p>
                      </div>
                      <ChevronRight className="h-5 w-5 text-white/20 group-hover:text-white/50 group-hover:translate-x-1 transition-all shrink-0 mt-1" />
                    </div>
                  </button>
                );
              })}
